...
(function () {
  ...
  var ES = {
    ...
    "nav.stack": "<i>02</i> Stack",
    "nav.work": "<i>03</i> Proyectos",
    "nav.exp": "<i>04</i> Experiencia",
    ...
    "ix.hero.lead": 'Soy <b>Mohamad</b> — llevo modelos desde datos sintéticos hasta inferencia serverless: optimizados con ONNX, en <b>AWS Lambda</b>, con CI/CD y ciclo de reentrenamiento. Me importa lo que pasa <b>después</b> de que el modelo converge — latencia, costo, drift.',
    ...
    "ix.hero.avail": '<span class="status__dot" aria-hidden="true"></span> Abierto a roles ML / MLOps · 2026',
    ...
    "ix.about.p1": 'Diseño y construyo sistemas de machine learning — desde <strong>pipelines de datos sintéticos</strong> que eliminan cuellos de botella de etiquetado hasta <strong>endpoints de inferencia serverless</strong> que se monitorean y reentrenan solos. Que el modelo converja es la parte fácil; a mí me importa lo que viene después.',
    "ix.about.p2": 'Ahora mismo soy pasante de investigación en ML / CV en <strong>Itaipu Parquetec</strong>, construyendo datasets sintéticos de 50 mil imágenes y pipelines de segmentación con Detectron2 + SAM2 para inspeccionar líneas de transmisión con drones. Mis proyectos personales también corren en producción: un <a class="ulink" href="conocetuave.html">clasificador de cantos de aves en AWS Lambda</a> con un ciclo de reentrenamiento con consentimiento y revisión humana, y una CNN multitarea para <a class="ulink" href="xrd-thesis.html">identificación de fases por XRD</a> entrenada íntegramente con espectros sintéticos.',
    "ix.about.p3": 'También me muevo cómodo por todo el stack de datos — desde Excel (certificado MOS) hasta pipelines de entrenamiento en PyTorch e inferencia en Lambda. Cuando no estoy programando, suelo estar leyendo post-mortems o afinando el pipeline de CI de alguien.',
    "ix.facts": '<div><dt>Ubicación</dt><dd>Paraguay (GMT&minus;3) · Abierto a remoto</dd></div><div><dt>Enfoque</dt><dd>MLOps · Visión por computadora · Datos sintéticos</dd></div><div><dt>Actualmente</dt><dd>Pasante de investigación ML / CV @ <span class="grad-text">Itaipu Parquetec</span></dd></div><div><dt>Herramientas</dt><dd>PyTorch · ONNX · AWS · Docker</dd></div><div><dt>Estado</dt><dd><span class="ok">●</span> Abierto a roles ML / MLOps</dd></div>',
    ...
    "ix.e0.list": '<li>Llevé a <b>producción un asistente de ventas interno con LLM</b> para un equipo comercial mayorista — búsqueda en lenguaje natural sobre un catálogo de <b>22.400 productos</b>, respondiendo con SKU, precio y stock reales.</li><li>Hice fine-tuning de <b>Qwen3-8B con QLoRA</b> sobre 2.172 trayectorias curadas de uso de herramientas: un benchmark de 60 casos reservados pasó de <b>88,3% a 95,0%</b> sin fallos críticos.</li><li>Construí el gate de despliegue (correctores mecánicos, aborto por contaminación) y lo corrí sobre 5 versiones — <b>bloqueó 2 de mis propios modelos</b>, cada uno con su análisis causal escrito.</li><li>Serví el modelo yo mismo en <b>vLLM</b> (FP8, prefix caching) sobre una sola RTX 5090: <b>p50 de 2,2s</b> en 309 turnos de producción; <b>80 loops concurrentes, 0 errores</b> bajo carga.</li><li>También construí un <b>buscador con IA para la tienda pública</b> — comparar, carrito, favoritos, links para compartir y entrada por voz — terminado pero no publicado durante el contrato.</li>',
    ...
    "ix.c.lead": "Estoy abierto a roles de ML / MLOps para 2026. La vía más rápida para contactarme es el email — suelo responder dentro del día.",
    ...
    "pt.lead": 'Un sistema de <b>segmentación de instancias de 18 clases</b> (SAM2 de Meta + Detectron2) que detecta y geolocaliza herrajes eléctricos en líneas de alta tensión a partir de imágenes de dron — entrenado con un <b>dataset sintético con máscaras autogeneradas</b>, en Itaipu Parquetec (PTI).',
